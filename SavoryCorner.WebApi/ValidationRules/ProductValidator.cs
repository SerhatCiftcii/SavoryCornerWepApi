...
namespace SavoryCorner.WebApi.ValidationRules
{
    public class ProductValidator:AbstractValidator<Product>
    {
        public ProductValidator()
        {
            ...
            RuleFor(x=>x.Price).NotEmpty().WithMessage("Ürün fiyatı boş geçilemez").LessThan(0).WithMessage("Ürün Fiyatı Negatif Olamaz.").GreaterThan(1000).WithMessage("Ürün fiyatı bukadar yüksek olamaz , girdiğiniz değeri kontrol edin");
